...
public class Home_Page {
    ...
    By Air = By.xpath("//*[@id='product-list']/div[8]/div/div[2]/form/div/button[2]");
    By MacBook = By.xpath("//*[@id='product-list']/div[7]/div/div[2]/form/div/button[2]");
    By VAIO = By.xpath("//*[@id='product-list']/div[5]/div/div[2]/form/div/button[2]");
    By Pro = By.xpath("//*[@id='product-list']/div[4]/div/div[2]/form/div/button[2]");
    By SamsungGalaxy = By.xpath("//*[@id='product-list']/div/div/div[2]/form/div/button[2]");
    By iPhone = By.xpath("//*[@id='product-list']/div[2]/div/div[2]/form/div/button[2]");
    By HTC = By.xpath("//*[@id='product-list']/div[1]/div/div[2]/form/div/button[2]");
    By Nikon = By.xpath("//*[@id='product-list']/div[2]/div/div[2]/form/div/button[2]");
    By Canon = By.xpath("(//button[@aria-label='Add to Wish List'])[2]");
    By iPodNano = By.xpath("//*[@id='product-list']/div[2]/div/div[2]/form/div/button[2]");
    By iPodClassic = By.xpath("//*[@id='product-list']/div[1]/div/div[2]/form/div/button[2]");
    ...
    public void AssertionForItemsAddedToCart(){
        ...
        Assert.assertFalse(pageSource.contains("Your wish list is empty."), "wish list is not empty");
    }
}
